...
def goto_location(self, command):
    ...
    if p:
        ...
        try:
            ...
            self.tn.send_message_to_player(player_object, "i have never heard of a location called {}".format(name), color='db500a')
...
def remove_location(self, command):
    ...
    if p:
        ...
        try:
            ...
            self.tn.send_message_to_player(player_object, "I have never heard of a location called {}".format(identifier), color='db500a')
