...
actions_dev.append(("isequal", "fix my legs please", fix_players_legs, "(self)"))
...
actions_dev.append(("isequal", "make me stop leaking", stop_the_bleeding, "(self)"))
...
actions_dev.append(("isequal", "heal me up scotty", apply_first_aid, "(self)"))
...
actions_dev.append(("isequal", "make me all powerful!", make_player_admin, "(self)"))
