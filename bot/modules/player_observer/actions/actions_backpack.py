    ...
    try:
        ...
        try:
            ...
            if location_object.player_is_inside_boundary(target_player):
                chrani_bot.telnet_observer.actions.common.trigger_action(chrani_bot, "pm", target_player, "eh, you already ARE near your pack oO".format(target_player.name), chrani_bot.dom["bot_data"]["settings"]["color_scheme"]['warning'])
            else:
                ...
                chrani_bot.telnet_observer.actions.common.trigger_action(chrani_bot, "say", "{} can't live without their stuff".format(target_player.name), chrani_bot.dom["bot_data"]["settings"]["color_scheme"]['standard'])
            ...
            chrani_bot.telnet_observer.actions.common.trigger_action(chrani_bot, "pm", target_player, "I don't have your last death on record, sorry :(".format(target_player.name), chrani_bot.dom["bot_data"]["settings"]["color_scheme"]['warning'])
